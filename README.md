...
```ts
import googleMapAutoCompletePlaces from 'sample-plugin';
...
The `googleMapAutoCompletePlaces` has already been installed to the `payload.config()` file in this project.
...
```ts
export const googleMapAutoCompletePlaces =
